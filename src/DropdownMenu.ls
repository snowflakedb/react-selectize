    ...
    render-dropdown: ({dynamic-class-name}) ->
        if @props.open
            ...
            DivWrapper do 
                ...
                style: if @props.dropdown-width and @props.open then {width:@props.dropdown-width, minWidth: '0px', bottom: if @props.dropdown-bottom then @props.dropdown-bottom else null} else {}
